...
This project is indexed by GitNexus as **BeFit-For-D-** (232 symbols, 353 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/BeFit-For-D-/context` | Codebase overview, check index freshness |
| `gitnexus://repo/BeFit-For-D-/clusters` | All functional areas |
| `gitnexus://repo/BeFit-For-D-/processes` | All execution flows |
| `gitnexus://repo/BeFit-For-D-/process/{name}` | Step-by-step execution trace |
